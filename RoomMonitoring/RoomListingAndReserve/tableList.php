...
// Fetch status from GET parameters
$statusFilter = isset($_GET['status']) ? $_GET['status'] : '';

// Prepare SQL query based on the selected status
$query = "SELECT room_number, floor, room_type FROM rooms";
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div>
            <div class="container">
                <!-- <h2>ROOM STATUS: <span style="color: rgb(207, 227, 98);">AVAILABLE</span></h2> -->
                <h2>ROOM STATUS:
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td class="border border-gray-400 px-4 py-2">
                                    <?php echo htmlspecialchars($row['floor'] . " - " . $row['room_type']); ?>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
