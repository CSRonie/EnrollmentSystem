...
<body>
        ...
        <div class="form-container">
            <form>
                ...
                <div class="form-group">
                    <label for="school-year">School Year/Term*</label>
                ...
                <!-- Year Level -->
                <div class="form-group">
                    <label for="college">Year Level:</label>
                    <select id="college" name="college">
                ...
                <div class="flex justify-end">
                    <a href="Display3.php" type="submit" style="background-color: #174069;"
    ...
    <div class="fixed bottom-6 right-6">
        <a href="Display1.php" type="submit" style="background-color: #aaa;" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
            Back
        </a>
    </div>
</body>
