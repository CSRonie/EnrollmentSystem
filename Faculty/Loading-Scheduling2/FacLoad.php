    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="form-container">
            <form>
                ...
                <!-- College Offered -->
                <div class="mb-4">
                    <label for="program-offered" class="block font-bold text-sm mb-2">COLLEGE*</label>
                ...
                <!-- Course Offered -->
                <div class="mb-4">
                    <label for="program-offered" class="block font-bold text-sm mb-2">COURSES*</label>
                    <select id="program-offered" class="w-full p-2 border border-gray-300 rounded">
                ...
                <!-- Year and Term (Two Inputs for Range) -->
                ...
                <div class="mb-4 flex items-center space-x-2">
                    <div class="flex-1">
                        <label for="school-year-from" class="block font-bold text-sm mb-2">YEAR LEVEL*</label>
                        <div class="flex items-center">
