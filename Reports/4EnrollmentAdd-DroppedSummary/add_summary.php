...
<head>
    ...
    <title>Enrollment Add Summary</title>
    ...
    <div class="main-content" id="mainContent">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <ul class="breadcrumb">
                ...
                <li class="active">Enrollment Add Summary</li>
            </ul>
        </nav>
        <section class="section-header text-sm md:text-xl">
            <h1>REPORTS - ENROLLMENT ADD SUMMARY</h1>
        </section>
        ...
        <div class="form-container">
            <div class="flex flex-wrap gap-4 mt-4">
                <div class="w-full sm:w-auto mb-4">
                    ...
                    <div class="border p-2 rounded-md w-full sm:w-32" style="width: 250px;">Add Summary</div>
                </div>
            </div>
                ...
                <table class="min-w-full border border-collapse">
                    <thead class="bg-gray-200">
                        <tr class="text-left">
                            ...
                            <th class="p-2 border">Course Code Added</th>
                            <th class="p-2 border">Course Name Added</th>
                        </tr>
                    </thead>
            ...
            <div class="flex justify-between mt-6">
                ...
                <a href="add_dropped_summary.php" type="button" class="bg-blue-900 text-white rounded-md p-2">Back</a>
            </div>
        </div>
    </div>
