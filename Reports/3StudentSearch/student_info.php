...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <section class="section-header text-sm md:text-xl">
            <h1>REPORTS - STUDENT INFORMATION</h1>
        </section>
        ...
        <div class="form-container">
            <div class="form-show flex flex-col gap-4">
                ...
                <div>
                    ...
                    <div class="border p-2 rounded-md w-full">Cruz, John A.</div>
                </div>
                <div>
                ...
                <div>
                    <label class="block font-bold">Year</label>
                    <div class="border p-2 rounded-md w-full">3rd</div>
                </div>
            </div>

            <h4 class="font-bold mb-4" style="margin-top: 25px; margin-bottom: 15px; margin-left: 200px;">STUDENT SUBJECT LOAD SCHEDULE</h4>
            ...
            <div class="table-container mt-8 overflow-x-auto">
                <table class="min-w-full border border-collapse">
                    ...
                    <tbody id="student-table-body">
                        <tr>
                            <td class="p-2 border">11-11111-11</td>
                            <td class="p-2 border">Doe</td>
                            <td class="p-2 border">John</td>

                        </tr>
                        <tr>
                            <td class="p-2 border">11-22222-22</td>
                            <td class="p-2 border">Del Cruz</td>
            ...
            <div class="flex justify-between mt-6">
                ...
                <a href="student_search.php" type="button" class="bg-blue-900 text-white rounded-md p-2">Back</a>
            </div>
        </div>
    </div>
