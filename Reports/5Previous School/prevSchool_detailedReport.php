...
<head>
    ...
    <title>Summary of Student from Previous School</title>
...
<body>
    ...
    <div class="main-content" id="mainContent">
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <ul class="breadcrumb">
                ...
                <li class="active">Student from Previous School</li>
            </ul>
        </nav>
        <section class="section-header text-sm md:text-xl">
            <h1>REPORTS - SUMMARY OF STUDENT FROM PREVIOUS SCHOOL</h1>
        </section>
                ...
                <div class="form-show flex flex-col gap-4">
                    ...
                    <div class="mb-6">
                        ...
                        <select id="program" class="w-full p-3 border border-gray-300 rounded">
                            ...
                            <option value="COA">Bachelor of Science in Information Systems</option>
                        </select>
                    </div>
                    <div class="w-full sm:w-auto mb-4">
                        <label class="block font-bold">SCHOOL</label>
                        <div class="flex items-center">
                            <input type="text" id="search-school" placeholder="Search for School" class="w-full p-2 border border-gray-300 rounded" />
                        </div>
                    </div>
                </div>

                <div class="flex justify-between mt-6">
                    <a href="studFr_PrevSchool.php" type="button" class="bg-blue-900 text-white rounded-md p-2">Back</a>
                    <a href="sum_prevSchool_search.php" type="button" class="bg-blue-900 text-white rounded-md p-2" onclick="showTable()">View</a>
                </div>
            </form>

            <!-- Hidden table container within the form-container -->
            <div id="tableContainer" class="table-container mt-8 overflow-x-auto hidden">
                <table class="min-w-full border border-collapse">
                    <thead class="bg-gray-200">
                        <tr class="text-left">
                            <th class="p-2 border">No.</th>
                            <th class="p-2 border">Previous School</th>
    ...
    <script>
        function showTable() {
            ...
            tableContainer.classList.toggle('hidden'); // Toggles visibility of the table
        }
