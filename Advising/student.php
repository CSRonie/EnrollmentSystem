        ...
        <div class="container mx-auto mt-8 bg-white p-8 rounded-lg shadow-lg max-w-7xl">
            <form class="space-y-6">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                    ...
                    <div class="col-span-2">
                        <input type="checkbox" id="date-time" class="mr-2">
                        <label for="date-time" class="font-semibold">Show Date and Time Enrolled</label>
                    </div>
                </div>

                <!-- Buttons -->
                <div class="flex justify-between mt-8">
                    <a href="NewStudent.php" style="background-color: #174069;" class="bg-blue-800 text-white py-3 px-6 rounded-full">
                        Search New Students
                    </a>
