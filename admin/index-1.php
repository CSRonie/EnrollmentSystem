...
if (isset($_GET['delete']) && isset($_GET['table'])) {
    ...
    $allowedTables = ['buildings', 'rooms', 'departments', 'education_levels', 'majors']; // List of valid tables
...
<body>
    ...
    <!-- Specific Role Form -->
    <div class="form-section">
        <h2>Specific Role Form</h2>
        <form id="specificRoleForm">
            <div class="form-group">
            ...
            <button type="submit">Save Specific Role</button>
        </form>
    </div>
    ...
    <script>
        ...
        function editRecordRoom(record) {
            ...
            document.getElementById('roomBuildingCode2').value = record.building_code;
            ...
            const test = document.getElementById('roomBuildingCode');
        ...
        function editRecordMajor(record) {
            ...
            console.log(document.getElementById('educationLevelIDRoom'))
        }
    </script>
</body>
